...
-- AddConstraint
-- A cart has exactly one owner: authenticated user XOR guest token — never
-- both set, never neither. Not expressible in Prisma schema syntax; enforced
-- at the database layer per db-design.md ("Constraints").
