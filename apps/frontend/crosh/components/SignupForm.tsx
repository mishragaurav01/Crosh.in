        ...
        <div className="max-w-[448px] mx-auto w-full">
            <header className="mb-lg">
                ...
                <p className="font-body-md text-body-md text-on-surface-variant">
                    Step into a world of slow fashion and handcrafted warmth.
                </p>
            </header>
            ...
            <div className="space-y-md">
                ...
                {/* Note the React syntax for onSubmit */}
                <form
                ...
                >
                    ...
                    <div className="flex items-start gap-md py-sm">
                        <div className="relative flex items-center">
                            <input
                                className="h-5 w-5 rounded-md border-outline text-primary focus:ring-primary-container bg-surface-container cursor-pointer"
                                id="newsletter"
                                type="checkbox"
                            />
                        </div>
                        ...
                        >
                            ...
                            <span className="text-primary font-bold">10% off</span> your first
                            order.
                        </label>
                    </div>
            ...
            <footer className="mt-lg text-center space-y-md">
                <p className="font-body-md text-body-md text-on-surface-variant">
                    ...
                    <a
                        className="font-label-md text-label-md text-primary hover:underline underline-offset-4 decoration-primary/30 transition-all"
                        href="/login"
                    >
                        Sign In
                    </a>
