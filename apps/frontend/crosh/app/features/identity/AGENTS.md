...
— those are governed by `apps/frontend/crosh/constitution/*.md`. This file
covers what's specific to these three screens.

**Tier 1 feature** (per `constitution/domain-map.md`).

Load alongside this file: `apps/frontend/crosh/constitution/frontend-architecture.md`,
`apps/frontend/crosh/constitution/design-system.md`, and the backend's
